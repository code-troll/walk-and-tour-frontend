...
export default function AboutUsIntroSection() {
    ...
    const contactHref = getInternalHref({
        locale,
    ...
    return (
        <section className="bg-[#fcfaf7] py-16">
            <div
                className="mx-auto grid w-full max-w-7xl items-center gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 lg:px-12">
                <div className="relative">
                    ...
                    <div
                        className="absolute bottom-4 left-4 inline-flex items-center gap-4 rounded-2xl border border-black/10 bg-white px-4 py-3 shadow-lg">
